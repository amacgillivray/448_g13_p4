...
dragElemnet(document.getElementById("mydiv"));
function dragElemnet(element){
    ...
    function elementDrag(e){
        ...
        element.style.left = (element.offsetLeft - pos 1) + "px";
    }
    function closeDragElement(){
        //mouse is realease when movement stopped
